sim.CCoccu.Dirichlet.SiteUse <-
  function(n.species=NA,psi=NA,theta=NA,lambda=NA,lambda.sd=NA,theta.sd=NA,
    ...
    parm.vals <- list(psi=psi,theta=theta,
                      lambda=lambda,lambda.sd=lambda.sd,theta.sd=theta.sd,G.alpha=G.alpha,pObs=pObs,pKnown=pKnown)
